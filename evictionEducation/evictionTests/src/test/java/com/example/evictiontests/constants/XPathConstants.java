...
public class XPathConstants {
    ...
    public static final String CHAT_BUTTON = "//a[text() = 'Chat']";
    public static final String CHAT_NOW_BUTTON = "//a[contains(text(), 'Chat Now')]";
    public static final String CONGRATS_TEXT = "//p[contains(text(), '🎉 Congrats, but additional resources may be available.')]";

    public static final String FAQS_BUTTON = "//a[contains(text(), 'FAQs')]";
    public static final String FIND_A_SOLUTION_BUTTON = "//a[contains(text(), 'Find A Solution')]";

    public static final String GOOGLE_TRANSLATE_DROPDOWN = "//div[@id = 'google_translate_element']";
    ...
    public static final String OPEN_CHATBOT_BUTTON = "//a[contains(text(), 'Open Chatbot')]";
    public static final String OPEN_MESSENGER_CHAT_BUTTON = "//button[contains(text(), 'Open Messenger Chat')]";
