...
INSERT INTO Decision_Node(node_id, is_leaf, display_type, question, node_language) VALUES (1, 0, 'Video', 'Have you been evicted yet?', 'English');
INSERT INTO Decision_Node(node_id, is_leaf, display_type, question, node_language) VALUES (2, 0, 'Text', 'Has an eviction notice been posted on you door?', 'English');
INSERT INTO Decision_Node(node_id, is_leaf, display_type, question, node_language) VALUES (3, 0, 'Text', 'Do you have dependents?', 'English');
INSERT INTO Decision_Node(node_id, is_leaf, display_type, question, node_language) VALUES (4, 1, 'Text', '', 'English');
INSERT INTO Decision_Node(node_id, is_leaf, display_type, question, node_language) VALUES (5, 1, 'Text', '', 'English');
INSERT INTO Decision_Node(node_id, is_leaf, display_type, question, node_language) VALUES (6, 1, 'Text', '', 'English');
INSERT INTO Decision_Node(node_id, is_leaf, display_type, question, node_language) VALUES (7, 1, 'Text', '', 'English');

INSERT INTO Question_Answer(parent_node, child_node, answer) VALUES (1, 3, 'Yes');
INSERT INTO Question_Answer(parent_node, child_node, answer) VALUES (1, 2, 'No');
INSERT INTO Question_Answer(parent_node, child_node, answer) VALUES (2, 4, 'Yes');
INSERT INTO Question_Answer(parent_node, child_node, answer) VALUES (2, 5, 'No');
INSERT INTO Question_Answer(parent_node, child_node, answer) VALUES (3, 6, 'Yes');
INSERT INTO Question_Answer(parent_node, child_node, answer) VALUES (3, 7, 'No');
